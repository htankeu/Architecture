  ...
  <div class="wrapper">
    ...
    <div class="col-12">
      <div class="post-title mb-3">
        <h1 class="entry-title display-4 display-2-lg mt-2">Comment gagner de l&#039;argent dans l&#039;agriculture en devenant producteur des intrants : engrais, fertilisants, herbicide etc. ?</h1>
      </div>
    </div>
    <div class="col-md-8">
        <!-- meta atribute -->
        <div class="post-atribute mb-4">
          <div class="mb-3 text-muted small">
            <!--author-->
                        <!--date-->
            <time class="ml-0 ml-sm-2 ml-md-3" datetime="2021-03-05 12:54:03">
              <span class="fa fa-clock"></span> 2021-03-05 12:54:03
            </time>
            <!--comments-->
            <span class="ml-2 ml-md-3" title="8 comments">
              <a class="text-muted" href="#comments"><span class="fa fa-comments"></span>8 Comments </a>
            </span>
          </div>
        </div>
        <!-- post content -->
        <div class="post-content">
                                                                                                    ...
                                                                                                    Aujourd'hui, l'Afrique importe l'essentiel de ses intrants pour l'agriculture. Ce qui n'a pas de sens, parce qu'elle exporte les minerais que les autres vont utiliser pour produire les engrais à nous revendre 100 fois plus chers. Alors, pourquoi ne pas le faire nous-mêmes ? <br>
                            <i style="background-color: red">Cet article a été archivé. </i><a data-toggle="modal" href="#suscribe_to_flash" > Obtenir un flash de lecture </a> / <a data-toggle="modal" href="#flash_cheker" > Lire a l'aide d'un code flash </a> / <a data-toggle="modal" href="#login" > je suis abonné  </a>
                                                                                </div>
        <!-- footer post -->
                                    ....
        ...
        <div class="modal fade" id="login" role="dialog" >
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <form id="conForm" method="POST" action="index.php?p=articles&artid=59">
                        <p>Se connecter</p>
                        <div class="container">
                            <div class="row">
                  ...
                  <form id="inscForm" style="display: none" method="POST" action="index.php?p=articles&artid=59">
                        <p>S'inscrire</p>
                        <div class="container">
                            <div class="row">
                    ...
                    <form id="reinitForm" style="display: none" method="POST" action="index.php?p=articles&artid=59">
        ...
        <div class="modal fade" id="abonement_nb_mois" role="dialog" >
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">  
                  <form id="abnForm" method="POST" action="index.php?p=articles&artid=59">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">  
                  ...
                  <div class="col-md-12 d-flex p-1 justify-content-center">
                    <a href="index.php?p=articles&artid=59"  class="btn">Continuer</a>
                  </div>             
              </div>
            </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">  
              <form method="POST" action="index.php?p=articles&artid=59">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12  form-group">
                                    <ul class="list-group">
                                        ...
                                        <input type="hidden" name="flash_article" value="59" required>
                                    </ul>
                                </div>
                                <div class="col-md-12  form-group">
                                    <ul class="list-group">
